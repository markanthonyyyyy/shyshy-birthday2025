...
const Card1 = ({ onReturn }) => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center gap-8 p-4">
      ...
      <button
        onClick={onReturn}
        className="border-2 font-bold text-pink-600 uppercase border-pink-600 bg-pink-100 hover:bg-pink-200 rounded-full px-8 py-3 text-sm transition-all hover:scale-105 animate-fade-in"
        style={{
